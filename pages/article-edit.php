    ...
    <div class="card-body">
      <form onsubmit="sendData(event)">
        ...
        <div class="row mb-6">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="basic-default-article_id" name="article_id"
              value="<?= $r['article_id'] ?>" disabled>
        ...
        <div class="row mb-6">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control " id="basic-default-author_id" name="author_id" placeholder="ID"
              value="<?= $r['author_id'] ?>" require>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-10">
            <textarea id="basic-default-content" class="form-control"
              placeholder="Hi, Do you have a moment to talk Joe?" aria-label="Hi, Do you have a moment to talk Joe?"
              aria-describedby="basic-icon-default-message2" rows="9" name="content"><?= $r['content'] ?></textarea>
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal"> <a href="./article.php"
            class="nav-link">
